...
class SavemartUSSpider(scrapy.Spider):
    """
    Save Mart Supermarkets (United States) spider.
    Wikidata: Q7428009
    ...
    name = "savemart_us"
    allowed_domains = ["savemart.com", "swiftlyapi.net"]

    # Store ID 1 has valid products/prices
    store_id = "1"
    api_base_url = "https://sm.swiftlyapi.net/search/api/v1/products/categories"
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(
            "https://savemart.com/", callback=self.parse_session
        )
    ...
    def parse_session(self, response):
        ...
        headers = {
            ...
            "Referer": "https://savemart.com/",
            "x-swiftly-banner-id": "b0fbc8a0-c305-4adc-97c0-80d7548ea2f9",
        }
    ...
    def parse_api(self, response):
        ...
        for p_data in products:
            ...
            # Build website URL
            product["website"] = (
                f"https://savemart.com/categories/"
            ...
            product["located_in_wikidata"] = "Q7428009"
            yield product
